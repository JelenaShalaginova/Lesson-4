...
public class PersonApp {
	public static void main(String args[]){
        ...
        create and save in memory an object with all its instance variables initialized to their default values, f
        or the Person object they are:
        ...
        */
		...
		//p4.age = 40; 
		// this would lead to a compilation error as age has been declared private; 
		//only if the age is declared public this statement is correct
		//use the setter method to change the age to 40
		p4.setAge(40);
		//call/invoke the method displayMe() on the object created above to display its details
		// note that john's age is not 0 any more, now it is 40
		p4.displayMe();
		//use the getter method to retrieve whether the p4 Person object enjoys reading
		boolean reads = p4.getEnjoysReading();
		//display whether john's enjoys reading
