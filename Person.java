...
public class Person {
    ...
    // a constructor is used to initialize the object's instance variables 
	...
	public Person(String aName, boolean reads, int myAge) {
        ...
        //declare a constructor with 3 parameters(boolean read
	/*
	...
	this constructor has a different signature namely, 
	Person(boolean reads, String n, int myAge) whereas the above is 
	Person(String aName, boolean reads, int myAge) -- note the different order of the parameters data types
	
	when we declare multiple constructors in a class the constructors must have different signatures 
	otherwise the compiler will generate a compilation error (i.e. constructor is already defined error)
	
	in general, when we overload constructors the signature must differ i.e. the parameters list must have
	different number of parameters, or if the parameter lists are of the same size, 
	then across two constructors the parameters must have different data types and different order of the parameters data types
	*/
    ...
    /* 
     ...
     if we do not declare ANY constructor in our class, 
     the java compiler generates and inserts in the .class file the default constructor  
    ...
    // added just to display the content of the instance variables immediately after an object creation 
	...
	public boolean getEnjoysReading() {return enjoysReading;}
